    ...
    <div>
      ...
      <div className="sectionContainer">
        ...
        <div className="sectionContent">
          ...
          journey by having the most affordable prices in town WITHOUT
          compromising on value and quality . Second, we seek to be transparent
          with our pricing. We hate it (and suspect you do too) when businesses
          try to hide how expensive something is going to be. As is the case
          with many sports, tuition is not the only cost you can expect, and
          we’ve done our honest best to list any other things you can expect to
          pay for here.
        </div>
      </div>
      <div className="sectionContainer">
        ...
        <div className="sectionContent">
          $50.00/month. No annual contract. Contact us to set up your TWO FREE
          TRIAL CLASSES!
        </div>
      </div>
      <div className="sectionContainer">
